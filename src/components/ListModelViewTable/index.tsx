...
const ListModelViewTable: Component<ListModelViewTableProps> = (props) => {
  ...
  const onRowCheck = (e: Event) => {
    ...
    props.onTableEvent("rowSelect", {
      rowSelected: { id: checkbox.id, isChecked },
    });
  };
  ...
  return (
    <div class="relative shadow-md sm:rounded-lg">
      ...
      <div class="overflow-x-auto">
        <table
          id={`main-table-${props.appLabel}-${props.modelName}`}
          class="w-screen text-sm text-left rtl:text-right table-auto"
        >
