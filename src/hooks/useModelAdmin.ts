...
export const hasAddModelPermission = (
  userPermissions: UserPermissionsType,
  appLabel: string,
  modelName: string
): boolean => {
...
export const hasViewModelPermission = (
  userPermissions: UserPermissionsType,
  appLabel: string,
  modelName: string
): boolean => {
...
export const hasChangeModelPermission = (
  userPermissions: UserPermissionsType,
  appLabel: string,
  modelName: string
): boolean => {
...
export const hasDeleteModelPermission = (
  userPermissions: UserPermissionsType,
  appLabel: string,
  modelName: string
): boolean => {
...
export const hasViewOnlyModelPermission = (
  userPermissions: UserPermissionsType,
  appLabel: string,
  modelName: string
): boolean => {
...
export const splitDateTimeString = (
...
export const getFilefieldLimits = (
  helpText: string
 ...
 */
export const buildModelFormData = (
 ...
 */
export const buildFieldStateOnError = (
  fieldsInFormState: FieldsInFormStateType,
  err: any
) => {
 ...
 */
export const buildFieldStateOnFieldChange = (
  fieldsInFormState: FieldsInFormStateType,
  fieldName: string,
  value: any,
  metadata: any
 ...
 */
export const updateFieldStateOnInvalidFields = (
  id: string,
  fieldsInFormState: FieldsInFormStateType,
 ...
 */
export const buildFieldStateOnFocus = (
  fieldsInFormState: FieldsInFormStateType,
  field: string
) => {
  let newFieldsState = { ...fieldsInFormState };
...
export const updateModelFieldsWithDbValues = (
  modelFields: ModelFieldsObjType,
...
export const initializeChangeFormFieldState = (
